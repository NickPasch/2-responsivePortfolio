...
import photoMe from "./images/photoMeNew.jpg";
import linkedIn from "./images/1280px-LinkedIn_Logo.svg.png";
        ...
        <div>
            <div className="container" className="home">
                ...
                <div className="row">
                  ...
                  <img src={photoMe} width="60%"/>
                  </div>
                </div>
              <br />
              <h2 animationIn="pulse" animationInDelay="3" id="link">LINKS</h2>
              <br />
                <div className="row">
                  <div className="col-md-2">
                  </div>
                  <div className="col-md-4">
                    <a href="https://www.linkedin.com/in/nicholas-pasch-7866a9186/" target="_blank"><img className="animate__animated animate__bounceInDown" src={linkedIn} height="200" width="350" /></a>
                  {/* <!-- <a className="animate__pulse" href="https://www.linkedin.com/in/nicholas-pasch-7866a9186/">LinkedIn</a> --> */}
                  </div>
                  <div className="col-md-4">
                    <a href="https://github.com/NickPasch" target="_blank"><img className="animate__animated animate__bounceInUp" src={gitHub} height="200" width="350" /></a>
                  </div>
